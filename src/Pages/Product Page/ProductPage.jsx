      ...
      {product && (
        <div className="w-full h-auto py-8 px-4 sm:px-8 md:px-16 bg-[#F6F4EB]">
          <div className="box">
            ...
            <div className="products flex flex-col md:flex-row items-center w-full px-2 mt-6">
              <div className="py-8 flex flex-col md:flex-row justify-evenly w-full">
                <div className="left w-full md:w-[45%] lg:w-[38%] h-auto pt-5 bg-[#848a8b4b] rounded-lg flex flex-col items-center mb-6 md:mb-0">
                  <div className="displayImg w-[90%] h-[60vw] md:h-[30vw] lg:h-[25vw] mx-auto shadow-lg rounded-3xl">
                    <img
                ...
                <div className="right w-full md:w-[50%] lg:w-[55%] h-auto p-4 flex flex-col gap-y-2.5">
                  ...
                  <p className="text-sm sm:text-lg font-semibold flex gap-x-3 items-center">
                  ...
                  <div className="flex gap-x-3 sm:gap-x-5 items-center mt-4">
                    <Link>
                      <div className="h-10 w-36 sm:w-40 text-center font-semibold bg-purple-700 text-white hover:text-purple-700 hover:bg-[#4547474d] transition-colors shadow-2xl rounded-md">
